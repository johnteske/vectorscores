...
var score = [
    ...
    {
        ids: [],
        message: 'The header and footer of a score will disappear when playing and will reappear when paused or stopped.',
        duration: 5
    },
    {
        ids: ['score-play'],
        message: 'To start or pause score play, click the play/pause button or press the spacebar.',
        duration: 3
    },
    {
        ids: ['score-stop'],
        message: 'To stop score play, click the stop button or press the escape key.',
        duration: 3
    },
    {
        ids: ['score-pointer'],
    ...
    },
    {
        ...
        message: 'When a score is not playing, you can set the score position with the forward and back buttons or by using the left and right arrow keys.',
        duration: 3
    },
    {
        ids: ['score-info-open'],
        message: 'If a score has additional information such as performance notes, they can be displayed by clicking the info button.',
        duration: 3
    },
    {
        ids: ['score-options-open'],
        message: 'If a score has options that can be set by performers, they can accessed by clicking the options button.',
        duration: 3
    },
    {
        ids: [],
...
function addTime(bar, i, score) {
    bar.time = score.slice(0, i).reduce(function(sum, bar2) {
