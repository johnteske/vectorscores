...
loadDomThenTest('VS#getRandExcl', { skip: sampleSize < 999 }, htmlPath, (t, window) => {
    const { VS } = window
...
loadDomThenTest('VS#getRandIntIncl', { skip: sampleSize < 999 }, htmlPath, (t, window) => {
    const { VS } = window
...
loadDomThenTest('VS#getItem', { skip: sampleSize < 999 }, htmlPath, (t, window) => {
    const { VS } = window
...
loadDomThenTest('VS#getWeightedItem', { skip: sampleSize < 999 }, htmlPath, (t, window) => {
    const { VS } = window
