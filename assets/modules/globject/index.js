VS.globject = function () {
  ...
  function globject(d, i) {
    ...
    if (rangeEnv.times) {
      ...
      rangePoints = rangePoints.concat(
        rangeEnv.hi.map(function (o) {
          return {
            x: o.time,
            y: o.value,
          };
  ...
  globject.width = function (_) {
    return arguments.length
      ? ((w = typeof _ === "function" ? _ : VS.constant(+_)), globject)
      : w;
  };

  globject.height = function (_) {
    return arguments.length
      ? ((h = typeof _ === "function" ? _ : VS.constant(+_)), globject)
      : h;
  };

  globject.curve = function (_) {
    return arguments.length
      ? ((c = typeof _ === "function" ? _ : c), globject)
      : c;
  };
